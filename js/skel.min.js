...
var skel = function() {
    var a = {
      ...
      changeState: function(d) {
        ...
        a.DOMReady(function() {
          var a, b;
          if ((a = document.getElementsByClassName("skel-cell-mainContent")) && 0 < a.length) if (a = a[0], f.config.grid.collapse) b = document.createElement("div"), b.innerHTML = "", b.id = "skel-cell-mainContent-placeholder", a.parentNode.insertBefore(b, a.nextSibling), a.parentNode.insertBefore(a, a.parentNode.firstChild);
        ...
        (function() {
          var b = window,
            c = function(a) {
              ...
              a = !1;
              if (!g) if (g = !0, "loading" !== d.readyState && l(), d.addEventListener) d.addEventListener("DOMContentLoaded", f, !1), b.addEventListener("load", f, !1);
